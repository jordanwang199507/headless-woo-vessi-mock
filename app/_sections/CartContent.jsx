...
import { CartItemCard, Button, PopularProductCard } from "@/app/_components";
import { bcTax } from "@/app/_constant";

const CartContent = ({ popularProducts }) => {
  ...
  return (
    <main>
      {/* cart */}
      <section className="xl:padding-l wide:padding-r padding-x pt-[88px]">
        <div className="max-container mt-10">
          <div className="flex gap-12 max-lg:flex-col">
            <div className="w-2/3 max-lg:w-full">
              <h3 className="font-bold font-fascinate text-3xl text-dark-gray">
                Your Cart
              </h3>
              {cartItems.length === 0 ? (
      ...
      <section className="padding-sm">
        <div className="max-container">
          <h3 className="text-3xl font-fascinate">
